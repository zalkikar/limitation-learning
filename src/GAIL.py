...
model = gensim.models.KeyedVectors.load_word2vec_format("/scratch/nsk367/limitation-learning/apps/dat/vectors/GoogleNews-vectors-negative300.bin.gz", binary=True)
